...
{
    internal class DbAccountingEntryChartItem : IDbAccountingEntryChartItem
    {
        ...
        internal static IDbAccountingEntryChartItem FromEfAccountingEntry(EfAccountingEntry efAccountingEntry)
        {
            ...
            return new DbAccountingEntryChartItem()
            {
