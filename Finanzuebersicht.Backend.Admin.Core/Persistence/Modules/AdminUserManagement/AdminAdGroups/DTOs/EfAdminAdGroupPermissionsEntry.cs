...
{
    [Table("AdminAdGroupPermissions")]
    public partial class EfAdminAdGroupPermissionsEntry : IEfPermissionsEntry
    {
        ...
        public virtual EfAdminAdGroup AdminAdGroup { get; set; }
    }
}