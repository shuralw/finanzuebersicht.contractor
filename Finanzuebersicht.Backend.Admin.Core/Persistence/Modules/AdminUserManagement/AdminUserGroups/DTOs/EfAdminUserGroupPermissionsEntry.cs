...
{
    [Table("AdminUserGroupPermissions")]
    public partial class EfAdminUserGroupPermissionsEntry : IEfPermissionsEntry
    {
        ...
        public virtual EfAdminUserGroup AdminUserGroup { get; set; }
    }
}