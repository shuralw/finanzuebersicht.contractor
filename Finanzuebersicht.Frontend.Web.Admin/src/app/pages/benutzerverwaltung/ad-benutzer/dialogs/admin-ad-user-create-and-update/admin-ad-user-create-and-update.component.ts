...
@Component({
  selector: 'app-admin-ad-user-create-and-update',
  templateUrl: './admin-ad-user-create-and-update.component.html',
  styleUrls: ['./admin-ad-user-create-and-update.component.scss']
})
export class AdminAdUserCreateAndUpdateComponent {
