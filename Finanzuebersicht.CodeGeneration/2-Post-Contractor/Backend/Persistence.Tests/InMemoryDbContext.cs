...
using Finanzuebersicht.Backend.Generated.Persistence.Tests.Modules.Accounting.StartSalden;
...
namespace SchuelerOnline.Backend.Generated.Persistence.Tests
{
    public static class InMemoryDbContext
    {
        ...
        public static PersistenceDbContext CreatePersistenceDbContextWithDbDefault()
        {
            ...
            persistenceDbContext.StartSalden.Add(DbStartSaldo.ToEfStartSaldo(DbStartSaldoTest.DbDefault(), StartSaldoTestValues.EmailUserIdDbDefault));
            persistenceDbContext.StartSalden.Add(DbStartSaldo.ToEfStartSaldo(DbStartSaldoTest.DbDefault2(), StartSaldoTestValues.EmailUserIdDbDefault));
